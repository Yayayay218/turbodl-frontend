            ...
            <div className="container">
                <div className="row justify-content-center">
                    ...
                    <div className="col-md-8 col-12">
                        <div className="row">
                            <div className={this.state.currentStepIndex === 0 ? "col-6 search-step search-active" : "col-6 search-step"}
                                onClick={()=>this.setState({currentStepIndex: 0})}
                            >
                                SEARCH
                            </div>
                            <div className={this.state.currentStepIndex === 1 ? "col-6 search-step search-active" : "col-6 search-step"}
